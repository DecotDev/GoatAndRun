...
import com.mygdx.goatandrun.jsonloaders.ButtonJson;
import com.mygdx.goatandrun.jsonloaders.ButtonLayoutJson;

import java.util.HashMap;
import java.util.Map;

public class PawLayout implements InputProcessor {
    ...
    public PawLayout(OrthographicCamera camera, AssetManager manager, BitmapFont font)
    {
        this.camera = camera;
